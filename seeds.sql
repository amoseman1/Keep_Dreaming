...
INSERT INTO destinations (location, cost_pp, activity_genre, activity_type, activity_title, number_people, kid_friendly) VALUES ("London", 2000, "abroad", "cultural", "museums",1, true),
  ...
  ('San Diego', 600, 'beach', 'active', 'surfing', 2, true),
  ('Taos', 300, 'mountains', 'active', 'skiing', 4, true),
  ('Thailand', 1500, 'abroad', 'volunteering', 'charity work', 1, true),
  ...
  ('Morocco', 3000, 'city', 'active', 'hiking', 2, true),
  ('Scotland', 2500, 'mountains', 'active', 'biking', 6, true),
  ('Ibiza', 3000, 'beach', 'partying', 'full moon party', 2, false),
  ("Grand Canyon", 1500, "mountains", "active", "rafting", 10, false),
